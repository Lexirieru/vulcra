...
import { Badge, SectionCard, TokenIcon } from "@/components/ui";
...
const ROW_GRID =
  "group flex flex-col gap-3 border-b border-line px-5 py-4 transition-colors last:border-b-0 hover:bg-surface-2/60 sm:grid sm:grid-cols-[minmax(0,2fr)_1fr_1fr_auto_auto] sm:items-center sm:gap-4";
  ...
  return (
    <Reveal className="min-w-0">
      <SectionCard
        ...
        bleed
      >
        <div className="hidden grid-cols-[minmax(0,2fr)_1fr_1fr_auto_auto] gap-4 border-b border-line bg-surface-2/50 px-5 py-3 text-xs font-medium text-muted sm:grid">
          <span>Position</span>
